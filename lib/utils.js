...
['Object', 'Array', 'Number', 'String', 'Boolean', 'Date', 'Symbol', 'Buffer', 'RegExp', 'Null', 'Undefined', 'Promise', 'Map', 'Set', 'AsyncFunction', 'GeneratorFunction'].forEach(type => {
...
_.validate = (data, {
  ...
  required,
  properties
}) => type === 'Object' ? _.keys(properties).every(key => _.validate(data[key], properties[key])) : _.isUndefined(data) ? required === false : _['is' + type](data);
